...
#include "compact_enc_det/encodings.pb.h"
...
int ToWindowsEncoding( const char* name ) {
  if( name == Null )
    return -1;

  if( strcmp( name, "ASCII"        ) == 0 ) return GetACP(); // TODO script CP ?
  if( strcmp( name, "WINDOWS-1250" ) == 0 ) return 1250;
  if( strcmp( name, "WINDOWS-1251" ) == 0 ) return 1251;
  if( strcmp( name, "WINDOWS-1252" ) == 0 ) return 1252;
  if( strcmp( name, "WINDOWS-1253" ) == 0 ) return 1253;
  if( strcmp( name, "WINDOWS-1254" ) == 0 ) return 1254;
  if( strcmp( name, "WINDOWS-1255" ) == 0 ) return 1255;
  if( strcmp( name, "WINDOWS-1256" ) == 0 ) return 1256;
  if( strcmp( name, "WINDOWS-1257" ) == 0 ) return 1257;
  if( strcmp( name, "WINDOWS-1258" ) == 0 ) return 1258;
  if( strcmp( name, "UTF-8"        ) == 0 ) return 65001;
  if( strcmp( name, "BIG5"         ) == 0 ) return 65001; // Impossible
  return -1;
}
